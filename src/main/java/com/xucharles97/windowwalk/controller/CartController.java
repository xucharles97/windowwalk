...
import com.xucharles97.windowwalk.model.AddToCartBody;
import com.xucharles97.windowwalk.model.CartDto;
import com.xucharles97.windowwalk.service.CartService;
import com.xucharles97.windowwalk.service.CustomerService;
import org.springframework.security.core.annotation.AuthenticationPrincipal;
import org.springframework.security.core.userdetails.User;
import org.springframework.web.bind.annotation.*;


// Endpoint handler for Cart stuff
@RestController
public class CartController {
    ...
    public CartDto getCart(@AuthenticationPrincipal User user) {
        // Get CustomerEntity from Spring's User object
